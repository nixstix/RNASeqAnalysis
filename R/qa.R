...
#' @param mc.cores A number specifying the number of cores to be used during parallel processing. Default is null - this will result in the number of cores in the default back-end being used. See \code{\link{BioCParallel::registered}}. 
